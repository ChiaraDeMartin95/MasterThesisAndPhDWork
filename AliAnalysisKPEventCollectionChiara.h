#ifndef AliAnalysisKPEventCollectionChiara_cxx
#define AliAnalysisKPEventCollectionChiara_cxx
#include <iostream>
#include <string>
#include "TObject.h"
#include "TH1.h"
...
class AliAnalysisKPEventChiara {

 public:
  AliAnalysisKPEventChiara();
  virtual ~AliAnalysisKPEventChiara();
  /* AliAnalysisKPEventChiara (const AliAnalysisKPEventChiara &obj); */
  /* AliAnalysisKPEventChiara &operator=(const AliAnalysisKPEventChiara &obj); */
  ...
  ClassDef(AliAnalysisKPEventChiara, 1);
  
};



class AliAnalysisKPEventCollectionChiara  {

 public:
  
  AliAnalysisKPEventCollectionChiara();
  AliAnalysisKPEventCollectionChiara(Short_t eventBuffSize, Int_t  maxFirstMult, Int_t  maxSecondMult);
  /* AliAnalysisKPEventCollectionChiara(const AliAnalysisKPEventCollectionChiara &obj); */
  /* AliAnalysisKPEventCollectionChiara & operator=(const AliAnalysisKPEventCollectionChiara &obj); */
  virtual  ~AliAnalysisKPEventCollectionChiara();
  ...
  ClassDef(AliAnalysisKPEventCollectionChiara, 1);
