...
void runTaskCorrelationhCasc(
	     ...
	     const char *taskname = "Xijetpp_LHC18f1_extra_15runs"   // sets name of grid generated macros
	     ){
  // check run type
  ...
  */
  ...
  AliAnalysisTaskCorrelationhCasc *task = AddTaskCorrelationhCasc("name",0.150,30,ishhCorr, isLocal, isMC, isEff, 5, EtaTrigger, EtahAssoc,EtaV0Assoc, FilterBitValue, year);
