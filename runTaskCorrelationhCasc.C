...
void runTaskCorrelationhCasc(
  ...
  */
  ...
  AliAnalysisTaskCorrelationhCasc *task = AddTaskCorrelationhCasc("name",0.150,30, isLocal, isMC, isEff, 5, EtaTrigger, EtahAssoc,EtaV0Assoc, FilterBitValue, year, "Xi");
