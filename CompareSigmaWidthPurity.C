...
void CompareSigmaWidthPurity(TString year0 = "LHC22f_pass2" /*"LHC22m_pass1"*/,
                             TString year1 = /*"LHC22s_PbPb" /*"LHC22f_pass2" */ "LHC16k_pass3",
                             TString Sfilein0 = "../Run3QA/LHC22f_pass2/PostProcessing_Train47130_22f.root" /* "../Run3QA/LHC22m_pass1/PostProcessing_Train44413_22m.root"*/,
                             TString Sfilein1 = /*"../Run3QA/LHC22f_pass2/PostProcessing_Train47130_22f.root"/*/ "../LHC16k_pass3/PostProcessLHC16k_pass3.root",
                             TString OutputDir = "../Run3QA/LHC22f_pass2/",
                             Bool_t isPseudoEfficiency = 1,
                             Bool_t isOnlyPseudoEfficiency = 0,
                             TString SPublishedYieldForPseudoEff = /*"../PbPbYields5TeV/SpectraAlessandro" /*"../PbPbYields5TeV/SpectraK0sPublished276TeV_2040Cent" */ "../PublishedYield13TeV/HEPData-ins1748157-v1-Table", // directory where published yields are stored
                             Bool_t ispp = 1)
{
  Int_t Choice = 0;
