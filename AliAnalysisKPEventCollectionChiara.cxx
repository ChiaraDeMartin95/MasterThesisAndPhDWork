...
AliAnalysisKPEventChiara::AliAnalysisKPEventChiara():
...
//_____________________________________________________________________________
AliAnalysisKPEventCollectionChiara::AliAnalysisKPEventCollectionChiara() : 
  fEvt(0x0), 
  fifo(0) 
{
...
AliAnalysisKPEventCollectionChiara::AliAnalysisKPEventCollectionChiara(Short_t eventBuffSize, Int_t maxFirstMult, Int_t maxSecondMult) : fEvt(0x0), fifo(0) {

  SetBuffSize(eventBuffSize);

  fEvt = new AliAnalysisKPEventChiara[fifo];  //allocate pointer array of AliAnalysisKPEvents
...
//_____________________________________________________________________________
void AliAnalysisKPEventCollectionChiara::FifoShift() { //Shift elements in FIFO by one and clear last element in FIFO 
...
void AliAnalysisKPEventCollectionChiara::FifoClear() { //Shift elements in FIFO by one and clear last element in FIFO 
