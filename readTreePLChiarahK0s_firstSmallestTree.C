...
#include <TFile.h>
#include <TLegend.h>
void readTreePLChiarahK0s_firstSmallestTree( Int_t sysV0=0,Int_t sysV0Index=0, Int_t type=0 /*type = 0 for K0s */,Bool_t SkipAssoc=1 ,Int_t israp=0, Bool_t ishhCorr=0, Float_t PtTrigMin=3, Float_t ptjmax=15, bool isMC = 1,Bool_t isEfficiency=1,Int_t sysTrigger=0,	    TString year=/*"2016kehjl_hK0s"/*"2016k_hK0s"/"17anch17_hK0s"*/"1617MC_hK0s"/*"2018f1_extra_hK0s_CP"*/, TString year0="2016", TString Path1 ="", Bool_t CommonParton=0, Int_t PtBinning=1, Bool_t isSysStudy=1, Int_t numsysV0index=20)
{

  if (sysV0!=0 && sysV0Index!=0) {cout << " this macro is meant to create a smaller tree, starting from the task output, with the needed variables after application of the loosest topological cuts (so to allow application of tighter cuts for systematic studies in macro readTreePLChiarahK0s_firstSys.C)" << endl; return; }
  ...
  Float_t LambdaMassWindowExtr[2] = {0, 0.009};
  ...
  if (sysV0==0 && isSysStudy){ //I set the loostest selections
    LambdaMassWindow = LambdaMassWindowExtr[0];
    ctau = ctauExtr[1];
    DCAV0ToPV = DCAV0ToPVExtr[1];
    DCAPosToPV = DCAPosToPVExtr[0];
    DCANegToPV = DCANegToPVExtr[0];
    CosinePAngle = CosinePAngleExtr[0];
  }
 ...
 tSignO->Branch("fTreeVariableDcaV0ToPrimVertex",  &fSignTreeVariableDcaV0ToPrimVertex   , "fSignTreeVariableDcaV0ToPrimVertex/D");
 tSignO->Branch("fTreeVariableDcaPosToPrimVertex", &fSignTreeVariableDcaPosToPrimVertex  , "fSignTreeVariableDcaPosToPrimVertex/D");
 tSignO->Branch("fTreeVariableDcaNegToPrimVertex", &fSignTreeVariableDcaNegToPrimVertex  , "fSignTreeVariableDcaNegToPrimVertex/D");
 ...
 tSignO->Branch("fTreeVariableInvMassK0s",         &fSignTreeVariableInvMassK0s, "fSignTreeVariableInvMassK0s/D");
 tSignO->Branch("fTreeVariableInvMassLambda",      &fSignTreeVariableInvMassLambda, "fSignTreeVariableInvMassLambda/D");
 tSignO->Branch("fTreeVariableInvMassAntiLambda",  &fSignTreeVariableInvMassAntiLambda, "fSignTreeVariableInvMassAntiLambda/D");
 ...
 // tSignO->Branch("fTreeVariableAssocDCAz",          &fSignTreeVariableAssocDCAz  , "fSignTreeVariableAssocDCAz/D");
 // tSignO->Branch("fTreeVariableAssocDCAxy",         &fSignTreeVariableAssocDCAxy  , "fSignTreeVariableAssocDCAxy/D");
 // tSignO->Branch("fTreeVariablePtArmenteros",       &fSignTreeVariablePtArmenteros  , "fSignTreeVariablePtArmenteros/D");
 // tSignO->Branch("fTreeVariableAlpha",              &fSignTreeVariableAlpha  , "fSignTreeVariableAlpha/D");
 // tSignO->Branch("fTreeVariableRapK0Short",         &fSignTreeVariableRapK0Short               ,"fSignTreeVariableRapK0Short/D");
 ...
 tBkgO->Branch("fTreeVariableDcaV0ToPrimVertex",  &fBkgTreeVariableDcaV0ToPrimVertex   , "fBkgTreeVariableDcaV0ToPrimVertex/D");
 tBkgO->Branch("fTreeVariableDcaPosToPrimVertex", &fBkgTreeVariableDcaPosToPrimVertex  , "fBkgTreeVariableDcaPosToPrimVertex/D");
 tBkgO->Branch("fTreeVariableDcaNegToPrimVertex", &fBkgTreeVariableDcaNegToPrimVertex  , "fBkgTreeVariableDcaNegToPrimVertex/D");
 ...
 tBkgO->Branch("fTreeVariableInvMassK0s",         &fBkgTreeVariableInvMassK0s, "fBkgTreeVariableInvMassK0s/D");
 tBkgO->Branch("fTreeVariableInvMassLambda",      &fBkgTreeVariableInvMassLambda, "fBkgTreeVariableInvMassLambda/D");
 tBkgO->Branch("fTreeVariableInvMassAntiLambda",  &fBkgTreeVariableInvMassAntiLambda, "fBkgTreeVariableInvMassAntiLambda/D");
 ...
 // tBkgO->Branch("fTreeVariableAssocDCAz",          &fBkgTreeVariableAssocDCAz  , "fBkgTreeVariableAssocDCAz/D");
 // tBkgO->Branch("fTreeVariableAssocDCAxy",         &fBkgTreeVariableAssocDCAxy  , "fBkgTreeVariableAssocDCAxy/D");
 // tBkgO->Branch("fTreeVariablePtArmenteros",       &fBkgTreeVariablePtArmenteros  , "fBkgTreeVariablePtArmenteros/D");
 // tBkgO->Branch("fTreeVariableAlpha",              &fBkgTreeVariableAlpha  , "fBkgTreeVariableAlpha/D");
 // tBkgO->Branch("fTreeVariableRapK0Short",         &fBkgTreeVariableRapK0Short               ,"fBkgTreeVariableRapK0Short/D");
