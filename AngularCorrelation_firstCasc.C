...
void AngularCorrelation_firstCasc(Int_t indexSysV0=0, Int_t sys=0, Bool_t SkipAssoc=0, Float_t ptjmin=3,  Float_t PtTrigMinFit=3, Int_t sysV0=0,Int_t type=0 /*0 = K0s, 8 = Xi*/,  Int_t israp=0, Bool_t isMC=0, Bool_t isEfficiency=0, TString yearME=/*"EPOSLHC_7BEvForhXi"/*"EPOSLHC_3BEvForhK0s"/*"EPOSLHC_IncreasedStatXi"/*"EPOS17d20b_hK0s"/*_Hybrid"/"PythiaMonash_IncreasedStatXi"/*"PythiaRopes"/*"_PythiaRopes_Test1"/*"17l3b_hK0s"/*"161718HM_hK0s"/*"16kl_hK0s_Hybrid"/*"2019h11_HM_hK0s"/*"161718_hXi"/"1617_GP_hK0s"/"AllhK0sHM_RedNo16k"/"161718_HM_hXi_WithFlat16k_No18p"/"161718Full_AOD234_hXi"/*"17pq_pp5TeV_hXi_pttrig0.15"/"17pq_hK0s"/*"17pq_pp5TeV_Hybrid"/"1617_AOD234_hK0s"/*"17pq_hK0s"/*"LHC16kl_pass2_GP_Fio_Hybrid"/"1617GP_hK0s_Hybrid_New"*/"1617_AOD234_hK0s"/*"161718_hXi"/*"161718_MD_New_hXi_Hybrid"/*"2018f1_extra_hK0s_Fio"/"17pq_hXi"/*"LHC17_AOD234_Red"/"AllhK0sHM_RedNo16k"/*"1617GP_hK0s"/*"2018f1_extra_15runs"/*"2018f1_extra_MylabelBis_15runs_hK0s_Hybrid"/*"2018f1_extra_Mylabel_15runs_hK0s_Hybrid"/*"2016k_HM_hK0s"/"1617_hK0s"/*"161718_MD_hXi_Hybrid_MCTruth"/*"2018f1g4_extra_hXi_Hybrid_MCTruth"/"2018f1_extra_15runs_NohDaughtersofK0s_hK0s_Hybrid"/*"2018g4_extra_EtaEff_hK0s_MCEff"*/, TString year="1617_AOD234_hK0s"/*"EPOSLHC_7BEvForhXi"/*"EPOSLHC_3BEvForhK0s"/*"EPOSLHC_IncreasedStatXi"/*"PythiaMonash_IncreasedStatXi"/*"_PythiaRopes_Test1"/*"17l3b_hK0s"/*"161718HM_hK0s"/*_Hybrid"/*"16kl_hK0s"/*"2019h11_HM_hK0s"/*"161718_hXi"/"1617_GP_hK0s"/ "17pq_hXi"/"AllhK0sHM_RedNo16k"/*"161718_HM_hXi_WithFlat16k_No18p"/"161718Full_AOD234_hXi"/**"17pq_pp5TeV_hXi_pttrig0.15"/*"17pq_hXi"/*"17pq_pp5TeV_Hybrid"/"1617_AOD234_hK0s"/*"17pq_hK0s"/*"LHC16kl_pass2_GP_Fio_Hybrid"/"1617GP_hK0s_Hybrid_New"/"1617_AOD234_hK0s"/*"161718_hXi"/*"161718_MD_New_hXi_Hybrid"/*"2018f1_extra_hK0s_Fio"/"17pq_hK0s"/*"LHC17_AOD234_Red"/"AllhK0sHM_RedNo16k"/*"1617GP_hK0s"/*"2018f1_extra_15runs"/*"2018f1_extra_MylabelBis_15runs_hK0s_Hybrid"//"2016k_HM_hK0s"/*"2018f1_extra_15runs_NohDaughtersofK0s_hK0s_Hybrid"/*"2018f1_extra_5runs_label_Hybrid_hK0s"/"1617_hK0s"/*"2018g4_extra_EtaEff_hK0s"/*"2018g4_extra_EtaEff_Hybrid_hK0s"/"161718_MD_EtaEff_hXi"/*"LHC16_17_GP_Hybrid_hXi"/*"2018f1g4_extra_hXi"/"2018g4_extra_hXi_SelTrigger"/*_15runsBis"/"1617_hK0s"/*AllMC_hXi"/"2018f1_extra_hK0s"/*"2016k_hK0s"/*"2016k_MECorr"/"Run2DataRed_MECorr_hXi"/*/, TString yearMC=""/*"EPOSLHC_7BEvForhXi"/*"EPOSLHC_3BEvForhK0s"/*"EPOSLHC_IncreasedStatXi"/*"EPOS17d20b_hK0s"/*_Hybrid"/"PythiaMonash_IncreasedStatXi"/*"PythiaRopes_IncreasedStatXi"/*"PythiaRopes"/*"_PythiaRopes_Test1"/*"17l3b_hK0s"/*"161718HM_hK0s"/*_Hybrid"/*"16kl_hK0s"/"2019h11_HM_hK0s_EffCorr"/*"161718_hXi"/*"161718Full_AOD235_hXi"/*"1617GP_hK0s_Hybrid_New" /"17pq_pp5TeV_Hybrid"/*"1617_GP_AOD235_With18c12b"/*"17pq_hK0s"/*"LHC16kl_pass2_GP_Fio_Hybrid"/*"1617GP_hK0s"/*"1617_GP_AOD235"/*"1617_GP_AOD235_With18c12b"/*"161718_hXi"/*"17pq_hK0s"/*"161718_MD_New_hXi_Hybrid"/*"2018f1_extra_hK0s_Fio"/*""//*"1617GP_hK0s"/*"2018f1_extra_15runs"/*"2018f1_extra_MylabelBis_15runs_hK0s_Hybrid"/"2019h11c_extra_HM_hK0s"/*"2018f1_extra_15runs_NohDaughtersofK0s_hK0s_Hybrid"/*"2018f1_extra_5runs_label_Hybrid_hK0s"/"1617MC_hK0s"/"2018g4_extra_EtaEff_hK0s"/*"161718_MD_EtaEff_hXi"/"2018f1g4_extra_hXi"/*"2018g4_extra_EtaEff_Hybrid_hK0s"/*"161718_MD_hXi_Hybrid"/*"LHC16_17_GP_Hybrid_hXi"/*"17d20bEPOS_hK0s"/"2018g4_extra_hXi_SelTrigger"/*"1617MC_hK0s"/"AllMC_hXi"/*"1617GP_hXi"/*"2016kl_hXi"/*"2018f1_extra_MECorr"/"2018f1_extra_Hybrid_hK0s"/*"17d20bEPOS_hXi"*/,  TString yearMCTrigEff=""/*"17l3b_hK0s"/*"161718HM_hK0s_TriggEff"/*"18f1_extra_EffTrigger_5runs"*/,  TString Dir ="FinalOutput/",  Float_t ptjmax=15, Bool_t isBkgParab=0, Bool_t isMeanFixedPDG=1, Int_t MultBinning=0, Int_t PtBinning=1, Bool_t isSysDef=1, Bool_t isDefaultSel=0, Bool_t IsPtTrigMultDep=0, Bool_t isLoosest=0, Bool_t isTightest=1, Bool_t IsParticleTrue=0,  Bool_t isSidebands=1, Bool_t isMESBFromPeak =0,  Bool_t isMEFromHybrid=0, Bool_t isMEFromCorrectCentrality = 0, Bool_t isEtaEff=1, Bool_t isMEFromK0s=0, Bool_t isNewInputPath=1, Bool_t isHM=0,  Int_t isNewdEtaJet =1, Bool_t isSysPurity =0, Int_t VarRange = 0, Bool_t isMCForNorm=0, Bool_t isEffCorr=0, Bool_t isGenOnTheFly=0, Bool_t isSpecialTest=0){ 
  ...
  if (isGenOnTheFly) { //these variabes have no meaning for the MCtruth analysis -- they are set to zero in order not to appear in output file name
    ...
    //else  isNewdEtaJet =0;
    isNewdEtaJet = 1;
    cout << "Do you want to run with the option isNewdEtaJet = 1 (type 1) or 2 (type 2) or 3 (type 3, for K0s JET of EPOSLHC)? (default choice of dEta region is different) "<< endl;
    cin >> isNewdEtaJet;
    //      isNewdEtaJet = 3; //for jet in EPOSLHC --> the only difference wrt to 2 is that at pt < 1.2 for K0s the dEta interval for jet is enlarged to 1.2
  ...
  */
  ...
  if (type>0 && sys==5 && ptjmin==3) {cout << "enlargening of DeltaEta region for bulk is posible only for K0s; anyway, run it! It is useful to store information on dEta choice of *Jet* region for sys=5. For Xi, sys = 5 is only used for jet production and it consists in: Jet dEta as default, OOJ dEta larger but *taken from Low pt triggered* events " << endl; 
    //  return;
  }
  ...
  Float_t LowLimit =0;
  Float_t LowLimitBis =0;
  if (isNewdEtaJet==2){ //built for MC truth (JET production)
    JetValue = 1; //pt-dependent (high pt bins: 0.96 (OOj sub: 0.96-1.3))
    JetValueDefault = 0.84;
    if (type==0) LowLimit = 2.; //pt cut-off (starting from this value on, the selection is tighter)
    else if (type==8) {
      LowLimit = 1.5;
      if (year=="EPOSLHC_7BEvForhXi") LowLimit=2;
    }
  }
  else if (isNewdEtaJet==3){ //built for MC truth (JET production), EPOSLHC
    JetValue = 1; //pt-dependent (high pt bins: 0.96 (OOj sub: 0.96-1.3))
    JetValueDefault = 0.84;
    if (type==0) LowLimit = 2.; //pt cut-off (starting from this value on, the selection is tighter)
  ...
  if (ishhCorr || (!ishhCorr && isEnlargedDeltaEtaPhi)) {//rendo ampiezza Jet uguale per hh e hK0s (l'output di hK0s è nel file DeltaEtaPhiEnlarged)
    ...
    if (isNewdEtaJet == 1){
    ...
    else if (isNewdEtaJet == 2 || isNewdEtaJet==3){
      ...
      if (sys==8) JetValue=1.2; //pt-independent 1.2 (OOj sub: 1.2-1.4)
    }
  }
  ...
  if (isNewdEtaJet == 1){
    ...
    else if (sys==5 && !ishhCorr){
      BulkUpValue=1.25;
    }
    else if (sys==6 && !ishhCorr){
      BulkLowValue=0.74;
    }
    else if (sys==7 && !ishhCorr){
    }
  ...
  if (isSysDef){
    if (isMEFrom13TeV)    PathInME =PathME + Form("_SysT%i_SysV00_Sys%i_PtMin%.1f", sysTrigger,sysang, PtTrigMin);   
    else if(isSysDef && isDefaultSel)    PathInME =PathME + Form("_SysT%i_SysV0Default_Sys%i_PtMin%.1f", sysTrigger,sysang, PtTrigMin);   
    //    if (isSysDef && isDefaultSel)    PathInME =PathME + Form("_SysT%i_SysV00_Sys%i_PtMin%.1f", sysTrigger,sysang, PtTrigMin);   
      ...
      if (isHM) PathInME = PathME + Form("_SysT%i_SysV0Default_Sys%i_PtMin%.1f", sysTrigger, sysang, PtTrigMin);
      else if (MultBinning==0 && type == 8) PathInME = PathME + Form("_SysT%i_SysV0indexBis%i_Sys%i_PtMin%.1f", sysTrigger, indexSysV0, sysang, PtTrigMin);
      else if (MultBinning==0 && type==0)  PathInME = PathME + Form("_SysT%i_SysV00_Sys%i_PtMin%.1f", sysTrigger, sysang, PtTrigMin);
      else PathInME = PathME + Form("_SysT%i_SysV0index%i_Sys%i_PtMin%.1f", sysTrigger, indexSysV0, sysang, PtTrigMin);
    }
  ...
  //PathInME += "_isEtaEff";
  if (MultBinning!=0 && !isMEFrom13TeV) PathInME += Form("_MultBinning%i", MultBinning);
  //  if (isSysPurity && isBkgParab) PathInME += BkgType[isBkgParab];
  ...
  else if(isSysDef && !isDefaultSel &&sysTrigger==0)    PathIn+= Form("_SysT%i_SysV0indexBis%i_Sys%i_PtMin%.1f", sysTrigger, indexSysV0, sysang, PtTrigMin);
  ...
  //  PathIn += "_Try1";
  if (SidebandsSide ==1) PathIn+= "_LeftSB";
  else if (SidebandsSide ==2) PathIn+= "_RightSB";
  if (isEtaEff) PathIn += "_isEtaEff";
  if (isTrigEff)  PathIn += "_isTrigEff";
  if (isBkgParab) PathIn += BkgType[isBkgParab];
  if (MultBinning!=0) PathIn += Form("_MultBinning%i", MultBinning);
  //  if (isSysPurity && isBkgParab) PathIn += BkgType[isBkgParab];
  ...
  TString MassFixedPDG[2]={"", "isMeanFixedPDG"};
  ...
  if (type>0){
    SPtV0[0]="0-0.5"; //kust used for MC truth
    SPtV0[1]="0.5-1";
  }
  ...
  */
  ...
  TH1D *fHistTriggervsMult_PtProj[nummolt+1];
  ...
  for(Int_t m=0; m<nummoltMax+1; m++){
    ...
    if(m<nummoltMax){
      ...
      fHistTriggervsMult_PtProj[m]= (TH1D*)fHistTriggervsMult->ProjectionX(Form("fHistTriggervsMult_PtProj_m%i", m), fHistTriggervsMult->GetYaxis()->FindBin(0+0.0001),fHistTriggervsMult->GetYaxis()->FindBin(100-0.0001) );
    }
  }
  ...
  TH1D *hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[nummolt+1][numzeta][numPtV0][numPtTrigger][numSB];
  ...
  TH1D *hDeltaEtaDeltaPhi_MEbins_ProjDPhiPos[nummolt+1][numzeta][numPtV0][numPtTrigger][numSB];
  ...
  TH1D *hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[nummolt+1][numzeta][numPtV0][numPtTrigger][numeta]; 
  ...
  TH1D *hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[nummolt+1][numzeta][numPtV0][numPtTrigger][numeta]; 
  ...
  Int_t   NTriggerNotEffCorrBis[nummolt+1]={0}; //total number of trigger particles 
  Float_t NTriggerEffCorr[nummolt+1]={0}; //total number of trigger particles corrected by trigger particle efficiency 
  ...
  for(Int_t m=0; m<nummoltMax+1; m++){
    ...
    NTriggerNotEffCorr[m]=NTrigger[m];    
  }
  ...
  if (isTrigEff){
    for(Int_t m=0; m<nummoltMax+1; m++){
      ...
      if (MultBinning==3 && (m==2 || m==3 || m==4)) continue;
      //    if (m==0) continue;
      Float_t EffTrigger =0;
      for(Int_t j=fHistTriggervsMult_PtProj[m]->GetXaxis()->FindBin(PtTrigMin+ 0.0001); j<=fHistTriggervsMult_PtProj[m]->GetXaxis()->FindBin(ptjmax-0.0001); j++ ){
	EffTrigger = fHistEfficiencyTrigPtPtBins[m]->GetBinContent(fHistEfficiencyTrigPtPtBins[m]->GetXaxis()->FindBin(fHistTriggervsMult_PtProj[m]->GetXaxis()->GetBinCenter(j)));
	NTriggerNotEffCorrBis[m]+= (float)fHistTriggervsMult_PtProj[m]->GetBinContent(j);
	NTriggerEffCorr[m]+= (float)fHistTriggervsMult_PtProj[m]->GetBinContent(j)/EffTrigger;
      }
      cout << "\nN trigger corrected by trigger particle efficiency in mult range " << m << "  " <<  NTriggerEffCorr[m] <<   endl;
      cout << "NTriggerEffCorr / NTrigger " << NTriggerEffCorr[m]/NTrigger[m] << endl;
      NTrigger[m]=NTriggerEffCorr[m];
    }
  }
  //*******************
  ...
  for(Int_t sb=0; sb< numSB; sb++){
	...
	if(!isMC || (isMC && isEfficiency)){
	  ...
	  if (isSysDef && isDefaultSel)	  PathInMassDef  += Form("_molt%i_sysT%i_sysV0Default_Sys%i_PtMin%.1f", m, sysTrigger,sysang,PtTrigMinFit);
	  else 	  if (isSysDef && isLoosest)	  PathInMassDef  += Form("_molt%i_sysT%i_sysV0Loosest_Sys%i_PtMin%.1f", m, sysTrigger,sysang,PtTrigMinFit);
	  else 	  if (isSysDef && isTightest)	  PathInMassDef  += Form("_molt%i_sysT%i_sysV0Tightest_Sys%i_PtMin%.1f", m, sysTrigger,sysang,PtTrigMinFit);
	  else if(isSysDef && !isDefaultSel && sysTrigger==0)	  PathInMassDef  += Form("_molt%i_sysT%i_sysV0index%i_Sys%i_PtMin%.1f", m, sysTrigger, indexSysV0,sysang,PtTrigMinFit);
	  else if(isSysDef && !isDefaultSel && sysTrigger==1)	  PathInMassDef  += Form("_molt%i_sysTindex%i_sysV0%i_Sys%i_PtMin%.1f", m, indexsysTrigger, 0,sysang,PtTrigMinFit);
	  else	{
	  ...
	  if (!IsParticleTrue){
	    ...
	    if (SidebandsSide==1) 	    histo_Bside[m]=(TH1F*)filepurezza->Get("histo_BsideL");
	    else if (SidebandsSide==2) 	    histo_Bside[m]=(TH1F*)filepurezza->Get("histo_BsideR");
	  }
	}
      }
	...
	for(Int_t tr=0; tr<numPtTrigger; tr++){
	  for(Int_t v=PtV0Min; v<numPtV0Max; v++){
	    ...
	    if (isMEFromHM){
	      ...
	      if (isMESBFromPeak) 	      hDeltaEtaDeltaPhi_MEbins[m][z][v][tr][sb]= (TH2D*)fileinME-> Get(nameME[m][z][v][tr][0]+ "_Effw");
	    }
	    else{
	    ...
	    /*
	    //CORRECTION FACTOR to remove wings
	    if (isWingsCorrectionApplied){
	      hDeltaEtaDeltaPhi_MEbins_ProjDPhiPos[m][z][v][tr][sb] = (TH1D*)hDeltaEtaDeltaPhi_MEbins[m][z][v][tr][sb]->ProjectionX(nameME[m][z][v][tr][sb]+"_norm_ProjDPhiPos",hDeltaEtaDeltaPhi_MEbins[m][z][v][tr][sb]->GetYaxis()->FindBin(+TMath::Pi()/2+ 0.001) ,hDeltaEtaDeltaPhi_MEbins[m][z][v][tr][sb]->GetYaxis()->FindBin(+3./2*TMath::Pi()- 0.001)  , "E");
	      hDeltaEtaDeltaPhi_MEbins_ProjDPhiPos[m][z][v][tr][sb]->Scale(2./(hDeltaEtaDeltaPhi_MEbins_ProjDPhiPos[m][z][v][tr][sb]->GetBinContent(hDeltaEtaDeltaPhi_MEbins_ProjDPhiPos[m][z][v][tr][sb]->FindBin(0.05)) + hDeltaEtaDeltaPhi_MEbins_ProjDPhiPos[m][z][v][tr][sb]->GetBinContent(hDeltaEtaDeltaPhi_MEbins_ProjDPhiPos[m][z][v][tr][sb]->FindBin(-0.05))));
	      hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb] = (TH1D*)hDeltaEtaDeltaPhi_SEbins[m][z][v][tr][sb]->ProjectionX(nameSE[m][z][v][tr][sb]+"_ProjDPhiPos",hDeltaEtaDeltaPhi_SEbins[m][z][v][tr][sb]->GetYaxis()->FindBin(+TMath::Pi()/2+ 0.001) ,hDeltaEtaDeltaPhi_SEbins[m][z][v][tr][sb]->GetYaxis()->FindBin(+3./2*TMath::Pi()- 0.001)  , "E");
	      hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->Scale(2./(hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->GetBinContent(hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->FindBin(0.05)) + hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->GetBinContent(hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->FindBin(-0.05))));
	      hDeltaEtaDeltaPhi_CorrFactor[m][z][v][tr][sb]= (TH1D*) hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->Clone(nameME[m][z][v][tr][sb]+"_ScalingFactor");
	      if (isMEFromCorrectCentrality){
		hDeltaEtaDeltaPhi_CorrFactor[m][z][v][tr][sb]->Divide(hDeltaEtaDeltaPhi_MEbins_ProjDPhiPos[m][z][v][tr][sb]);
	      }
	      else {
		hDeltaEtaDeltaPhi_CorrFactor[m][z][v][tr][sb]->Divide(hDeltaEtaDeltaPhi_MEbins_ProjDPhiPos[nummoltMax][z][v][tr][sb]);
	      }
	      //this is a DeltaEta dependent correction factor which should be applied to the ME distribution
	      //Let's first transform it in a 2D histogram
	      hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]= (TH2D*)hDeltaEtaDeltaPhi_MEbins[m][z][v][tr][sb]->Clone(nameME[m][z][v][tr][sb]+"_2DScaligFactor");
	      for (Int_t j=1; j<= hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]->GetNbinsX(); j++){ //dEta axis
		for (Int_t i=1; i<= hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]->GetNbinsY(); i++){ //dPhi axis
		  Int_t Bin2D=  hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]->GetBin(j,i);
	      ...
	      if (isMEFromCorrectCentrality){
		hDeltaEtaDeltaPhi_MEbins[m][z][v][tr][sb]->Divide(hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]);
	      }
	      else {
		hDeltaEtaDeltaPhi_MEbins[m][z][v][tr][sb] = (TH2D*) hDeltaEtaDeltaPhi_MEbins[nummoltMax][z][v][tr][sb]->Clone(Form("hDeltaEtaDeltaPhi_MEbins_WCorr_m%i", m));
		hDeltaEtaDeltaPhi_MEbins[m][z][v][tr][sb]->Divide(hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]);
	      }
	    }
	    ...
	    */
	    ...
	    //CORRECTION FACTOR to remove wings
	    if (isWingsCorrectionApplied){
	      hDeltaEtaDeltaPhi_ME_normbins_ProjDPhiPos[m][z][v][tr][sb] = (TH1D*)hDeltaEtaDeltaPhi_ME_normbins[m][z][v][tr][sb]->ProjectionX(nameME[m][z][v][tr][sb]+"_norm_ProjDPhiPos",hDeltaEtaDeltaPhi_ME_normbins[m][z][v][tr][sb]->GetYaxis()->FindBin(+TMath::Pi()/2+ 0.001) ,hDeltaEtaDeltaPhi_ME_normbins[m][z][v][tr][sb]->GetYaxis()->FindBin(+3./2*TMath::Pi()- 0.001)  , "E");
	      hDeltaEtaDeltaPhi_ME_normbins_ProjDPhiPos[m][z][v][tr][sb]->Scale(2./(hDeltaEtaDeltaPhi_ME_normbins_ProjDPhiPos[m][z][v][tr][sb]->GetBinContent(hDeltaEtaDeltaPhi_ME_normbins_ProjDPhiPos[m][z][v][tr][sb]->FindBin(0.05)) + hDeltaEtaDeltaPhi_ME_normbins_ProjDPhiPos[m][z][v][tr][sb]->GetBinContent(hDeltaEtaDeltaPhi_ME_normbins_ProjDPhiPos[m][z][v][tr][sb]->FindBin(-0.05))));
	      hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb] = (TH1D*)hDeltaEtaDeltaPhi_SEbins[m][z][v][tr][sb]->ProjectionX(nameSE[m][z][v][tr][sb]+"_ProjDPhiPos",hDeltaEtaDeltaPhi_SEbins[m][z][v][tr][sb]->GetYaxis()->FindBin(+TMath::Pi()/2+ 0.001) ,hDeltaEtaDeltaPhi_SEbins[m][z][v][tr][sb]->GetYaxis()->FindBin(+3./2*TMath::Pi()- 0.001)  , "E");
	      hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->Scale(2./(hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->GetBinContent(hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->FindBin(0.05)) + hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->GetBinContent(hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->FindBin(-0.05))));
	      hDeltaEtaDeltaPhi_CorrFactor[m][z][v][tr][sb]= (TH1D*) hDeltaEtaDeltaPhi_SEbins_ProjDPhiPos[m][z][v][tr][sb]->Clone(nameME[m][z][v][tr][sb]+"_ScalingFactor");
	      if (isMEFromCorrectCentrality){
		hDeltaEtaDeltaPhi_CorrFactor[m][z][v][tr][sb]->Divide(hDeltaEtaDeltaPhi_ME_normbins_ProjDPhiPos[m][z][v][tr][sb]);
	      }
	      else {
		hDeltaEtaDeltaPhi_CorrFactor[m][z][v][tr][sb]->Divide(hDeltaEtaDeltaPhi_ME_normbins_ProjDPhiPos[nummoltMax][z][v][tr][sb]);
	      }
	      //this is a DeltaEta dependent correction factor which should be applied to the ME distribution
	      //Let's first transform it in a 2D histogram
	      hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]= (TH2D*)hDeltaEtaDeltaPhi_ME_normbins[m][z][v][tr][sb]->Clone(nameME[m][z][v][tr][sb]+"_2DScaligFactor");
	      for (Int_t j=1; j<= hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]->GetNbinsX(); j++){ //dEta axis
		for (Int_t i=1; i<= hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]->GetNbinsY(); i++){ //dPhi axis
		  Int_t Bin2D=  hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]->GetBin(j,i);
		  hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]->SetBinContent(Bin2D, 1./hDeltaEtaDeltaPhi_CorrFactor[m][z][v][tr][sb]->GetBinContent(j)); 
	    ...
	    hDeltaEtaDeltaPhi_ME_normbins[m][z][v][tr][sb]->GetYaxis()->SetTitle("#Delta#varphi ");
	    ...
	    hDeltaEtaDeltaPhi_SEbins[m][z][v][tr][sb]->GetYaxis()->SetTitle("#Delta#varphi ");
	    ...
	    hDeltaEtaDeltaPhi_MEbins[m][z][v][tr][sb]->GetYaxis()->SetTitle("#Delta#varphi ");
	    hDeltaEtaDeltaPhi_ACbins[m][z][v][tr][sb]->GetXaxis()->SetTitle("#Delta#eta");
	    hDeltaEtaDeltaPhi_ACbins[m][z][v][tr][sb]->GetYaxis()->SetTitle("#Delta#varphi ");
		...
		if (NPtV0[v] < LowLimit){	JetValue=1.1; BulkLowValue =1.1; BulkUpValue=1.35;}
 	    ...
 	    else if (isNewdEtaJet == 3){
	      if (sys == 0){
		if (type==8) {	JetValue=1.2; BulkLowValue =1.2; BulkUpValue=1.35;}
		else {
		  if (NPtV0[v] < LowLimitBis){	JetValue=1.2; BulkLowValue =1.2; BulkUpValue=1.35;}
		  else if (NPtV0[v] < LowLimit){	JetValue=1.1; BulkLowValue =1.1; BulkUpValue=1.35;}
		  else {JetValue=1.; BulkLowValue = 1.; BulkUpValue=1.25;}
		}
	      }
	    }
	    ...
	    */
	    ...
	    for(Int_t eta=0; eta<numeta; eta++){
	      //	      cout << " eta " << eta << endl;
	      hDeltaEtaDeltaPhi_ACbins_phi[m][z][v][tr][sb][eta]->SetTitle("#Delta#varphi projection in " +Proj[eta] + TitleString[m][v][sb]);
	      hDeltaEtaDeltaPhi_ACbins_phi[m][z][v][tr][sb][eta]->GetXaxis()->SetTitle("#Delta#varphi ");
		...
		if (!IsParticleTrue){
	      ...
	      hDeltaEtaDeltaPhi_ACbins_phi[m][z][v][tr][sb][eta]->SetTitle("Relative errors of #Delta#varphi projection in " +Proj[eta] + TitleString[m][v][sb]);
	...
	for(Int_t v=PtV0Min; v<numPtV0Max; v++){
	  if (!ishhCorr){
	    ...
	    if(!isMC || (isMC && isEfficiency)){
	      ...
	      hDeltaEtaDeltaPhi_MErap[m][z][v][tr]->GetYaxis()->SetTitle("#Delta#varphi ");
	  ...
	  for(Int_t eta=0; eta< numeta; eta++){
	    ...
	    */
	    ...
	    if (!IsParticleTrue)	  {
	      ...
	      //Plotting
	      hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][eta]= (TH1D*) hDeltaEtaDeltaPhi_ACbins_phi_V0Sub[m][z][v][tr][eta]->Clone(nameME[m][z][v][tr][0]+Form("_eta%i_AC_phi_BeforeSBSub", eta)); 
	      hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][eta]= (TH1D*) hDeltaEtaDeltaPhi_ACbins_phi[m][z][v][tr][1][eta]->Clone(nameME[m][z][v][tr][0]+Form("_eta%i_AC_phi_SB_NTrigg", eta)); 
	      //*************
	    ...
	    hDeltaEtaDeltaPhi_ACbins_phi_V0Sub[m][z][v][tr][eta]->GetXaxis()->SetTitle("#Delta#varphi ");
	  ...
	  */
	  ...
	  hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][1]->Scale(ScaleFactorBulk[m][z][v][tr]);
	  hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][1]->Scale(ScaleFactorBulk[m][z][v][tr]);
	  hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][1]->SetLineColor(kGreen+3);
	  hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][1]->SetMarkerColor(kGreen+3);
	  hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][1]->SetLineColor(kGreen+3);
	  hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][1]->SetMarkerColor(kGreen+3);
	  ...
	  cout << "Look here! pt: " << NPtV0[v] << ", Eta jet:  " << hDeltaEtaDeltaPhi_ACbins[m][z][v][tr][0]->GetXaxis()->GetBinLowEdge(hDeltaEtaDeltaPhi_ACbins[m][z][v][tr][0]->GetXaxis()->FindBin(JetValue)) << endl;
	  cout << "Look here! pt: " << NPtV0[v] << ", Default Eta jet:  " << hDeltaEtaDeltaPhi_ACbins[m][z][v][tr][0]->GetXaxis()->GetBinLowEdge(hDeltaEtaDeltaPhi_ACbins[m][z][v][tr][0]->GetXaxis()->FindBin(JetValueDefault)) << endl;
	  ...
	  hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][0]->Scale(ScaleFactorJetNotDef[m][z][v][tr]);
	  hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][0]->Scale(ScaleFactorJetNotDef[m][z][v][tr]);
	  hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][0]->SetLineColor(kRed);
	  hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][0]->SetMarkerColor(kRed);
	  hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][0]->SetLineColor(kRed);
	  hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][0]->SetMarkerColor(kRed);
	  ...
	  hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][2]->Scale(ScaleFactorJetBulk[m][z][v][tr]);
	  hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][2]->Scale(ScaleFactorJetBulk[m][z][v][tr]);
	  hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][2]->SetLineColor(kBlue);
	  hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][2]->SetMarkerColor(kBlue);
	  hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][2]->SetLineColor(kBlue);
	  hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][2]->SetMarkerColor(kBlue);
  ...
  for(Int_t sb=0; sb< numSB; sb++){
	...
	for(Int_t tr=0; tr<numPtTrigger; tr++){
	  for(Int_t v=PtV0Min; v<numPtV0Max; v++){
	    ...
	    hDeltaEtaDeltaPhi_MEbins_rapMolt[m][z][v][tr][sb]->GetYaxis()->SetTitle("#Delta#varphi ");
  ...
  else if(isSysDef && !isDefaultSel &&sysTrigger==0)     PathOut1+=   Form("_SysT%i_SysV0indexBis%i_Sys%i_PtMin%.1f_Output", sysTrigger, indexSysV0, sys, PtTrigMin);
  ...
  if (isMESBFromPeak) PathOut1+= "_SBMEFromPeak";
  ...
  if (SidebandsSide ==1) PathOut1+= "_LeftSB";
  else if (SidebandsSide ==2) PathOut1+= "_RightSB";
  if (isEtaEff) PathOut1+= "_IsEtaEff";
  if (isTrigEff) PathOut1+= "_IsTrigEff";
  ...
  else if (isNewdEtaJet == 3)  PathOut1 += "_NewdEtaChoice3";
  //  PathOut1 += "_Try1";
  ...
  for(Int_t m=0; m<nummoltMax+1; m++){
	...
	for(Int_t v=PtV0Min; v<numPtV0Max; v++){
	  ...
	  for(Int_t sb=0; sb<numSB; sb++){
	    ...
	    if (isWingsCorrectionApplied){
	      hDeltaEtaDeltaPhi_CorrFactor[m][z][v][tr][sb]->Write();
	      hDeltaEtaDeltaPhi_CorrFactor2D[m][z][v][tr][sb]->Write();
	    }
	  ...
	  for (Int_t eta=0; eta<=2; eta++){
	    hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][eta]->Scale(1./NTrigger[m]);
	    hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][eta]->Scale(1./NTrigger[m]);
	    hDeltaEtaDeltaPhi_ACbins_phi_V0Sub[m][z][v][tr][eta]->Write();
	    hDeltaEtaDeltaPhi_ACbins_phi_V0Sub_BeforeSBSub[m][z][v][tr][eta]->Write();
	    hDeltaEtaDeltaPhi_ACbins_phi_SB_NTrigg[m][z][v][tr][eta]->Write();
  ...
  if (isSidebands){
    for(Int_t m=0; m<nummoltMax+1; m++){
      ...
      for(Int_t v=PtV0Min; v<numPtV0Max; v++){
	//	cout << "\nCiaoo: pt : " << v << " " <<  hDeltaEtaDeltaPhi_SEbins[m][0][v][0][1] ->GetEntries() << endl;
	//	if (!IsParticleTrue){      cout << "B/Bs: " <<    (Float_t)histo_Bcentral[m]->GetBinContent(histo_Bcentral[m]->FindBin(NPtV0[v]+0.0001))/histo_Bside[m]->GetBinContent(histo_Bside[m]->FindBin(NPtV0[v]+0.0001)) << endl;	}
      }
    }
  }
  ...
  for(Int_t m=0; m<nummoltMax+1; m++){
    ...
    if (isTrigEff){
      cout << "NTrigger(not effcorr bis) --SHOULD be the same as the one above " << NTriggerNotEffCorrBis[m] << endl;
      cout << "NTriggerEffCorr " << NTrigger[m] << endl;
      cout << "NTriggerEffCorr/NTrigger " << NTrigger[m]/NTriggerNotEffCorr[m]<<endl;
    }
    else {
