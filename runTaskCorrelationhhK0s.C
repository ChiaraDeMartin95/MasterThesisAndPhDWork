...
void runTaskCorrelationhhK0s(
	     ...
	     const char *taskname = "K0sjetpp_LHC18f1_extra_Hybrid_label_15runs" //LHC18f1_extra_15runsNOFB_150MeV"   // sets name of grid generated macros
	     ){
  // check run type
  ...
  */
  ...
  gROOT->LoadMacro("AliAnalysisTaskCorrelationhhK0s.cxx++g");
  gROOT->LoadMacro("AddTaskCorrelationhhK0s.C");
  ...
  AliAnalysisTaskCorrelationhhK0s *task = AddTaskCorrelationhhK0s(3,30,ishhCorr, isLocal, isMC, isEff,isHybridMCTr, 5, EtaTrigger, EtahAssoc,EtaV0Assoc, FilterBitValue, year, "K0s", isHM, "suffix");
...
AliAnalysisGrid* CreateAlienHandler(const char *taskname, const char *gridmode, const char *proofcluster, const char *proofdataset)
{
  ...
  //for MC 18g4_extra                                                                                 
  //plugin->SetGridDataDir("/alice/sim/2018/LHC18g4_extra");                                          
  ...
  //17d20a2_extra   plugin->SetDataPattern("/AOD/*/AliAOD.root"); 
  ...
  //2018g4 (170M INT7)                                                                                 
  //  Int_t nrun[25]={285009, 285011, 285012, 285013, 285014, 285015, 285064, 285065, 285066, 285106, 285108, 285125, 285127, 285165, 285200, 285202, 285203, 285222, 285224, 285327, 285328, 285347, 285364, 285365, 285396};  
 ...
 //  Int_t nrun[146] = { 258303, 258302, 258301, 258299, 258278, 258274, 258273, 258271, 258270, 258258, 258257, 258256, 258204, 258203, 258202, 258198, 258197, 258178, 258117, 258114, 258113, 258109, 258108, 258107, 258063, 258062, 258060, 258059, 258053, 258049, 258045, 258042, 258041, 258039, 258019, 258017, 258014, 258012, 258008, 258003, 257992, 257989, 257986, 257979, 257963, 257960, 257957, 257939, 257937, 257936, 257855, 257853, 257851, 257850, 257804, 257803, 257800, 257799, 257798, 257797, 257773, 257765, 257757, 257754, 257737, 257735, 257734, 257733, 257727, 257725, 257724, 257697, 257694, 257692, 257691, 257689, 257688, 257687, 257685, 257684, 257682, 257644, 257642, 257636, 257635, 257632, 257630, 257606, 257605, 257604, 257601, 257595, 257594, 257592, 257590, 257588, 257587, 257566, 257562, 257561, 257560, 257541, 257540, 257539, 257537, 257531, 257530, 257492, 257491, 257490, 257488, 257487, 257474, 257468, 257457, 257433, 257364, 257358, 257330, 257322, 257320, 257318, 257260, 257224, 257209, 257206, 257204, 257144, 257141, 257139, 257138, 257137, 257136, 257100, 257095, 257092, 257086, 257084, 257082, 257080, 257077, 257012, 257011, 256944, 256942, 256941};
  //  Int_t nrun[151]= {258359, 258336, 258332, 258307, 258306, 258303, 258302, 258301, 258299, 258278, 258274, 258273, 258271, 258270, 258258, 258257, 258256, 258204, 258203, 258202, 258198, 258197, 258178, 258117, 258114, 258113, 258109, 258108, 258107, 258063, 258062, 258060, 258059, 258053, 258049, 258045, 258042, 258041, 258039, 258019, 258017, 258014, 258012, 258008, 258003, 257992, 257989, 257986, 257979, 257963, 257960, 257957, 257939, 257937, 257936, 257855, 257853, 257851, 257850, 257804, 257803, 257800, 257799, 257798, 257797, 257773, 257765, 257757, 257754, 257737, 257735, 257734, 257733, 257727, 257725, 257724, 257697, 257694, 257692, 257691, 257689, 257688, 257687, 257685, 257684, 257682, 257644, 257642, 257636, 257635, 257632, 257630, 257606, 257605, 257604, 257601, 257595, 257594, 257592, 257590, 257588, 257587, 257566, 257562, 257561, 257560, 257541, 257540, 257539, 257537, 257531, 257530, 257492, 257491, 257490, 257488, 257487, 257474, 257468, 257457, 257433, 257364, 257358, 257330, 257322, 257320, 257318, 257260, 257224, 257209, 257206, 257204, 257144, 257141, 257139, 257138, 257137, 257136, 257100, 257095, 257092, 257086, 257084, 257082, 257080, 257077, 257012, 257011, 256944, 256942, 256941};
  ...
  plugin->SetAnalysisSource("AliAnalysisCorrelationEventCollection.cxx  AliAnalysisTaskCorrelationhhK0s.cxx");
  ...
  plugin->SetAdditionalLibs("libOADB.so AliAnalysisCorrelationEventCollection.h AliAnalysisCorrelationEventCollection.cxx AliAnalysisTaskCorrelationhhK0s.h AliAnalysisTaskCorrelationhhK0s.cxx");
