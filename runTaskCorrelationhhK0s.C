...
void runTaskCorrelationhhK0s(
	     ...
	     const char *taskname = "K0sjetpp_LHC18f1_extra_15runs_150MeV"   // sets name of grid generated macros
	     ){
  // check run type
  ...
  */
  ...
  AliAnalysisTaskCorrelationhhK0s *task = AddTaskCorrelationhhK0s("name",0.150,30,ishhCorr, isLocal, isMC, isEff, 5, EtaTrigger, EtahAssoc,EtaV0Assoc, FilterBitValue, year);
